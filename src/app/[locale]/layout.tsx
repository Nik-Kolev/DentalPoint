                    ...
                    <div className='flex flex-col items-center md:flex-row md:items-start md:justify-between gap-10'>
                        ...
                        <div className='flex gap-16'>
                            ...
                            <div className='flex flex-col gap-4'>
                                <p className='font-montserrat text-xs font-semibold uppercase tracking-[0.15em] text-white/40'>{t('footerNav')}</p>
                            ...
                            {/* Contact */}
                            <div className='flex flex-col gap-4'>
                                <p className='font-montserrat text-xs font-semibold uppercase tracking-[0.15em] text-white/40'>{t('footerContact')}</p>
